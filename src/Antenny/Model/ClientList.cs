...
namespace Antenny.Model
{
    ...
    /// ClientList
    /// </summary>
    [DataContract(Name = "ClientList")]
    public partial class ClientList : IEquatable<ClientList>, IValidatableObject
    {
        /// <summary>
        ...
        public ClientList(List<ModelClient> items = default(List<ModelClient>), string lastKey = default(string))
        {
            this.Items = items;
        ...
        public List<ModelClient> Items { get; set; }
        ...
        {
            return this.Equals(input as ClientList);
        }

        /// <summary>
        /// Returns true if ClientList instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientList input)
        {
            if (input == null)
                return false;
